<style>
    ...
    .menu_text_center, .menu_text_left, .menu_text_right, .sub, .sup, .create_italics, .create_bold, .dow_file, .create_title, .normal, .create_underline, .create_strike, .plus{
        background: #fff;
        cursor: pointer;
        border: 1px solid;
        color: crimson;
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: url(google.woff2) format('woff2');
    }
